...
export const constraintErrorMap: Record<string, ServerError> = {
  ...
  sender_routing_rules_sender_profile_id_sender_profiles_id_fk: new ServerError(AppErrorCode.SND_PRF_003),
  ...
  sender_routing_rules_service_region_message_type_unique: new ServerError(AppErrorCode.SND_RTR_002),
};
